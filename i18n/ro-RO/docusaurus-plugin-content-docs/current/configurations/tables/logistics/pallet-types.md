...
Acest tabel gestionează codificarea diverselor *Tipuri de unități de încărcare*. Permite alegerea parametrilor care permit optimizarea planurilor de încărcare (de exemplu: greutate și dimensiune).
